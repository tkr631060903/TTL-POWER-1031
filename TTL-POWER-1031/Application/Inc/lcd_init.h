...
#define LCD_SCLK_Clr() HAL_GPIO_WritePin(LCD_SPI_SCK_GPIO_Port, LCD_SPI_SCK_Pin, GPIO_PIN_RESET)//SCL=SCLK
#define LCD_SCLK_Set() HAL_GPIO_WritePin(LCD_SPI_SCK_GPIO_Port, LCD_SPI_SCK_Pin, GPIO_PIN_SET)
