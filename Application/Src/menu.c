...
//     {
//     case LEFT:
//         (sub_index.presset_config_set_current_index > 0) ? (sub_index.presset_config_set_current_index--) : (sub_index.presset_config_set_current_index = 0);
//         presset_config_page_ui_process(sub_index.presset_config_set_current_index);
//         break;
//     case RIGHT:
//         (sub_index.presset_config_set_current_index < 2) ? (sub_index.presset_config_set_current_index++) : (sub_index.presset_config_set_current_index = 2);
//         presset_config_page_ui_process(sub_index.presset_config_set_current_index);
//         break;
//     case KEY1_SHORT:
//         set_presset_config(KeyValue);
