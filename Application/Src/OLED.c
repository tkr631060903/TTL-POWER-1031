...
/*引脚配置*/
#define OLED_W_SCL(x) HAL_GPIO_WritePin(OLED_I2C_SCL_GPIO_Port, OLED_I2C_SCL_Pin, (GPIO_PinState)(x))
#define OLED_W_SDA(x) HAL_GPIO_WritePin(OLED_I2C_SDA_GPIO_Port, OLED_I2C_SDA_Pin, (GPIO_PinState)(x))
